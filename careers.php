                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="career-opening">
                                        <?php echo $vacancy['vacancy_seats'] ?>
                                    </span>
                                </td>
                                <td><?php echo date('F d, Y', strtotime($vacancy['starting_date'])) ?> </td>
                                <td><?php echo date('F d, Y', strtotime($vacancy['termination_date'])) ?> </td>
                                <td class="product-wishlist-cart">
                                    <a href="career.php?id=<?php echo $vacancy['id'] ?>">View Details</a>
                                </td>
                            </tr>
